/**
 * Created by mvandeberg on 17/08/15.
 */
...
function createCube(gl) {
    ...
    var verts = [
        ...
        // Todo complete the face

    ];

    // Todo once the cube is rendred change the colour of the faces
    ...
    var faceColors = [
        [1.0, 1.5, 0.5, 1.0], // Front face
        [1.5, 15, 1.0, 1.0], // Back face
        [0.5, 0.0, 1.0, 1.0], // Top face
        [1.0, 0.0, 0.5, 1.0], // Bottom face
        [1.0, 0.5, 1.0, 1.0], // Right face
