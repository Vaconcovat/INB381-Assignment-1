...
window.onload = function init() {
    ...
    //try and set up the shadow here
    ...
    //set a black colour vector for the shadow
    ...
    multyLoc = gl.getUniformLocation( program, "multy" );
